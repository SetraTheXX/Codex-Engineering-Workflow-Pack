...
Usage:
  ...
  cewp workflow propose --proposal <definition.json> [(--goal <text> | --from <source>) --compiler-digest <sha256>] [--source-kind <kind>] [--json]
  cewp workflow approve --proposal <definition.json> [(--goal <text> | --from <source>) --compiler-digest <sha256>] --digest <sha256> --yes [--json]
  cewp workflow status <run-id> [--json]
  cewp workflow start <run-id> --task <task-id> [--worker <worker-id>] --yes [--json]
  ...
  cewp supervise cancel [run-id] --yes [--json]
  cewp supervise abandon [run-id] --yes [--json]
